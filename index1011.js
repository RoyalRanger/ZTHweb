...
function calculateBuyFromTmg(Tmg) {
    ...
    const impact = (remPrice + Stats.aPrice) / Stats.aPrice
    const effectivePrice = NQTToNumber(bSigna + Config.contractActivation + Config.transactionFee + Config.amountFee)
...
async function evtBuy() {
    ...
    numberBalance += NQTToNumber(Config.amountFee)  // ввод суммы для оплаты
